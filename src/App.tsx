...
import { loadTeams, saveTeams, loadCompetitions, saveCompetitions } from './utils/storage';
  ...
  return (
    <div className="app">
      ...
      <div className="main">
        ...
        {view === 'comps' && (
          <CompetitionManager competitions={competitions} onUpdate={handleCompetitionsUpdate} />
        )}
